...
class HeaderLoginComponent extends Component {
    ...
    contactnoCheck = () => {
        ...
        if (contactno.length > 0) {
            if (
                !onlynumberExprs.test(contactno) ||
                !(contactno.length === 10)
            ) {
    ...
    loginClickHandler = (e) => {
        ...
        if (valid)
            loginCustomer(contactno, password, this.onLoginRequestComplete);
    };
        ...
        return (
            <React.Fragment>
                ...
                >
                    ...
                    <div
                        className={
                            this.state.tabValue === 0 ? "dispBlock" : "dispNone"
                        }
                    >
                        <TabContainer
                            className={
                        ...
                        >
                            ...
                            >
                                ...
                                <FormHelperText
                                    className={
                                        this.state.loginContactnoRequired
                                    }
                                >
                                    <span className="red">required</span>
                                </FormHelperText>
                                <FormHelperText
                                    className={this.state.loginContactnoInvalid}
                                >
                            ...
                            <FormControl
                                required
                                className="login-form-control mg-top-10"
                            >
                                <FormHelperText
                                    className={
                                        this.state.loginServerErrorMsgShow
                                    }
                                >
                                    <span className="red">
                                        {this.state.loginServerErrorMsg}
                                    </span>
                                </FormHelperText>
                            </FormControl>
                            <br />
                    ...
                    <div
                        className={
                            this.state.tabValue === 1 ? "dispBlock" : "dispNone"
                        }
                    >
                        <TabContainer>
                            <FormControl
                            ...
                            >
                                ...
                                <FormHelperText
                                    className={this.state.invalidEmailRequired}
                                >
                            ...
                            >
                                ...
                                <Input
                                    ...
                                    onChange={
                                        this.inputRegisterPasswordChangeHandler
                                    }
                                />
                                <FormHelperText
                                    className={
                                        this.state.registerPasswordRequired
                                    }
                                >
                                    <span className="red">required</span>
                                </FormHelperText>
                                <FormHelperText
                                    className={
                                        this.state.invalidPasswordRequired
                                    }
                                >
                                    <span className="red">
                                        Password must contain at least one
                                        capital letter, one small letter, one
                            ...
                            >
                                ...
                                <FormHelperText
                                    className={
                                        this.state.invalidContactNoRequired
                                    }
                                >
                                    <span className="red">
                            ...
                            >
                                <FormHelperText
                                    className={this.state.regServerErrorMsgShow}
                                >
                                    <span className="red">
                                        {this.state.regServerErrorMsg}
                                    </span>
                                </FormHelperText>
                            </FormControl>
                            <br />
