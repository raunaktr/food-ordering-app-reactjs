...
class Checkout extends Component {
                        ...
                        >
                            {this.state.noDataNoteNumeric === 1 && (
                                <Typography
                                    ...
                                    style={{ marginTop: 20 }}
                                >
                                    There are no saved addresses! You can save
                                    an address using the 'New Address' tab or
                                    using your ‘Profile’ menu option.
                                </Typography>
                            )}
                            {this.state.noDataNoteNumeric === 0 && (
                                <TabPanel value={this.state.value} index={0}>
                                    <GridList
                                        cols={3}
                                        className={
                                            classes.gridListUpcomingMovies
                                        }
                        ...
                        <TabPanel value={this.state.value} index={1}>
                            <FormControl>
                                ...
                                <Input
                                    ...
                                    onChange={this.inputflatNumberChangeHandler}
                                    className="user-adr-field"
                                />
                                <FormHelperText
                                    className={this.state.flatnoRequired}
                                >
    ...
    tabToggleChange = (event, newValue) => {
    ...
    inputflatNumberChangeHandler = (event) => {
                                    ...
                                    >
                                        <div className="total-price-summary">
                                            ...
                                            <div>
                                                ...
                                                <strong>
                                                    {" " +
                                                        this.state.data.cartitems.bill.toFixed(
                                                            2
                                                        )}
                                                </strong>
                                            </div>
