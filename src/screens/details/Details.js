...
class Details extends Component {
    onRestaurantByIdRequestComplete = (code, response) => {
        if (code === 200) {
            ...
            this.setState({
                restaurantDetails: restaurantItems,
        ...
        return (
            <div>
                ...
                <div className="rst-body-section">
                    ...
                    >
                        {this.state.categoryRestaurantlist.map(
                            (category, catIndex) => (
                                <div
                                ...
                                >
                                    ...
                                    {category.item_list.map(
                                        (item, itemIndex) => (
                                            <div
                                                key={"fooditem-" + itemIndex}
                                                className="food-item-list"
                                            >
                    ...
                    {/**  Restaurant Menu-items Module End Here **/}

                    {/**  Restaurant Food-Cart Module **/}
                            ...
                            <CardContent className="food-card-body">
                                ...
                                <div className="total-price-summary">
                                    ...
                                    <div>
                                        ...
                                        <strong>
                                            {" " +
                                                this.state.totalBillPrice.toFixed(
                                                    2
                                                )}
                                        </strong>
                                    </div>
